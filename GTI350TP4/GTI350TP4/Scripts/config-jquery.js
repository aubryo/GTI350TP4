...
$(document).ready(function () {
    ...
    $("#activeFilter").click(function () {
        ...
        changeImageForStep(3, true)
    });
    $("#save").click(function () {

       // $(this).textContent("Sauvegarde en cours...");
        $(this).prop('value', 'Sauvegarde en cours...');
        setTimeout(
             function () {
                 window.location.href = "http://localhost:22171/Account/UserProfile";
            }, 2000);
      
    });
    $("#activeFilter").on("click");
    ...
    $("#processeur").find("a").click(function () {
        ...
        changeImageForStep(parseInt(progress), false);
    });
    ...
    $("#piece1").click(function () {
        ...
        $("div[step='" + progress + "']").find(".step-progression-footer").find("img").attr("src", "http://cdn.mysitemyway.com/icons-watermarks/simple-green/bfa/bfa_check-circle/bfa_check-circle_simple-green_512x512.png");
    ...
    $("#previousStep").click(function () {
        ...
        changeImageForStep(previousStep, false);
    });
    ...
    $("#nextStep").click(function () {
        ...
        changeImageForStep(nextStep, false);
    });

    function changeImageForStep(step, filtre) {
        if (step === 1) {
            var dataSet = [
          ...
          { src: "http://media.ldlc.com/ld/products/00/00/98/05/LD0000980501_1.jpg", spec1: "USB Slot:2", spec2: "Dim: 25x25", price: "Prix: 50.00$" }
            ...
            var dataSet = [
           { src: "http://www.intel.com/content/dam/support/us/en/images/processors/sb/img/corei5unlockedsbbox1to1nbg.jpg", spec1: "Patriot Viper", spec2: "Dual-Core", price: "Prix: 200.00$" },
           ...
           { src: "https://images-na.ssl-images-amazon.com/images/I/51dgA33KpmL._SY355_.jpg", spec1: "AMD-A-Serie", spec2: "Quadra-Core", price: "Prix: 350.00$" }
            ...
            if (filtre) {
                var dataSet = [{ src: "http://www.corsair.com/Media/catalog/product/v/e/veng_k_angle_4.png", spec1: "Corsair", spec2: "16GB", price: "Prix: 250.00$" },
       { src: "https://d3fa68hw0m2vcc.cloudfront.net/5f3/125327552.jpeg", spec1: "Corsair", spec2: "8GB", price: "Prix: 120.00$" },
       ...
       { src: "http://www.geeky-gadgets.com/wp-content/uploads/2011/03/OWC-16GB-MacBook_pro.jpg", spec1: "Corsair", spec2: "16GB", price: "Prix: 250.00$" },
       { src: "http://www.pcgameware.co.uk/images/Patriot-Viper-16Gb-2400MHz-Box-Contents.jpg", spec1: "Corsair", spec2: "16GB", price: "Prix: 200.00$" },
       { src: "http://img.hexus.net/v2/memory/adata/xpg2133/ModulesB.jpg", spec1: "Corsair", spec2: "8GB", price: "Prix: 125.00$" }
                ];
        ...
        { src: "http://img.hexus.net/v2/memory/adata/xpg2133/ModulesB.jpg", spec1: "Xtreme Series", spec2: "8GB", price: "Prix: 125.00$" }
          ...
          { src: "http://www.oneclicksolutions.com.au/wp-content/uploads/2015/05/WD-Blue-HDD.jpg", spec1: "HDD", spec2: "1TB", price: "Prix: 150.00$" }
            ...
            var dataSet = [
          { src: "https://files.graphiq.com/5030/media/images/_4286738.jpg", spec1: "Intel", spec2: "RAM:32GB", price: "Prix: 250.00$" },
          { src: "http://cdn.mos.cms.futurecdn.net/b5XerwXJrsM6HFEDS9LAP4.png", spec1: "Intel", spec2: "RAM:128GB", price: "Prix: 375.00$" },
          { src: "http://www.pngall.com/wp-content/uploads/2016/04/Motherboard-PNG-Picture.png", spec1: "Asus", spec2: "RAM:64GB", price: "Prix: 350.00$" },
          { src: "http://s3.thingpic.com/images/9T/TJep3sKdVbHBroLoJqFf26Jv.jpeg", spec1: "GIGABYTE", spec2: "RAM:64GB", price: "Prix: 250.00$" },
          { src: "http://xtreview.com/images/Asus-P6T-deluxe-119.jpg", spec1: "Asus", spec2: "RAM:128GB", price: "Prix: 450.00$" },
          { src: "http://www.legitreviews.com/images/reviews/1024/asus_m4a785td_evo.jpg", spec1: "Asus", spec2: "RAM:64GB", price: "Prix: 350.00$" }
            ];
